    ...
    <section id="committes" className="py-24 bg-white overflow-hidden scroll-mt-32">
      <div className="container mx-auto px-6 lg:max-w-[1280px]">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-16">
          {patronData.map((patron, i) => (
            <motion.div 
              ...
              whileHover={{ y: -5 }}
              className="group p-8 bg-[#f8f9fa] rounded-[32px] border border-black/5 hover:border-[#0d5c2e]/20 hover:bg-white hover:shadow-2xl transition-all duration-500"
            >
              <div className="flex items-start gap-6">
                <div className="w-16 h-16 bg-[#0d5c2e] text-white rounded-2xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 group-hover:rotate-3 transition-transform duration-500">
                  {patron.icon}
                </div>
                <div>
        ...
        <div className="grid lg:grid-cols-3 gap-6 mb-16">
          {coreTeam.map((member, i) => (
            <motion.div 
              ...
              whileHover={{ y: -10 }}
              className="bg-[#0d5c2e] p-8 rounded-[32px] text-white transition-all duration-500 relative overflow-hidden group shadow-xl"
            >
              ...
              <div className="relative z-10">
                <div className="w-12 h-12 bg-white/20 backdrop-blur-md rounded-xl flex items-center justify-center mb-6 group-hover:bg-yellow-400 group-hover:text-[#0d5c2e] transition-colors duration-500">
                  {member.icon}
                </div>
                ...
                {member.email && (
                  <a href={`mailto:${member.email}`} className="inline-flex items-center gap-2 text-xs font-bold text-yellow-400 hover:text-white transition-colors">
                    {member.email}
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          className="bg-[#f8f9fa] rounded-[40px] p-10 border border-black/5 relative overflow-hidden"
        >
          <div className="absolute top-0 right-0 w-64 h-64 bg-yellow-400/5 rounded-full blur-3xl" />
          <h3 className="text-2xl font-black text-[#0d5c2e] mb-10 flex items-center gap-4 relative z-10">
