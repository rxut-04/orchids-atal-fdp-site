...
const HeroSection = () => {
  ...
  return (
    <section 
      id="home"
      className="relative min-h-[100vh] flex items-center pt-16 lg:pt-20 pb-12 overflow-hidden scroll-mt-32"
    >
          ...
          <div className="grid lg:grid-cols-12 gap-8 items-center">
                    ...
                    <div className="lg:col-span-8 text-white pr-4 text-center lg:text-left">
                      <motion.div 
                        ...
                        className="flex flex-wrap items-center justify-center lg:justify-start gap-6 mt-4 md:mt-8 mb-6 md:mb-10"
                      >
