...
const AboutSection = () => {
  return (
        <section 
          id="about" 
          className="bg-[#f8f9fa] relative py-16 md:py-24 lg:py-32 overflow-hidden scroll-mt-32"
        >
      ...
      <div className="container relative z-10 mx-auto px-6 lg:max-w-[1280px]">
          ...
          <div className="max-w-3xl mb-12 md:mb-20 text-center lg:text-left">
            <span className="text-[#0d5c2e] font-black tracking-[0.2em] uppercase text-xs md:text-sm mb-4 block">Information Hub</span>
            <h2 className="text-3xl md:text-5xl font-black text-[#0d5c2e] leading-tight tracking-tighter">
              EMPOWERING RURAL INDIA <br className="hidden sm:block" />
              <span className="text-yellow-600">THROUGH EXCELLENCE</span>
            </h2>
          </div>

          <div className="grid lg:grid-cols-2 gap-8 md:gap-12 lg:gap-20 items-start mb-24">
            
            {/* Main Info Columns */}
            <div className="space-y-8 md:space-y-12">
              <div className="group p-6 md:p-8 bg-white rounded-[32px] shadow-xl shadow-black/5 hover:shadow-2xl hover:shadow-[#0d5c2e]/10 transition-all duration-500 border border-black/5">
                <div className="w-12 h-12 md:w-14 md:h-14 bg-[#0d5c2e] text-white rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-500">
                  <Users size={24} className="md:w-[28px] md:h-[28px]" />
                </div>
                <h3 className="text-xl md:text-2xl font-black text-[#0d5c2e] mb-4">Pravara Rural Education Society</h3>
                  <p className="text-gray-600 leading-relaxed text-left md:text-justify text-sm md:text-base">
              ...
              <div className="group p-6 md:p-8 bg-white rounded-[32px] shadow-xl shadow-black/5 hover:shadow-2xl hover:shadow-[#0d5c2e]/10 transition-all duration-500 border border-black/5">
                <div className="w-12 h-12 md:w-14 md:h-14 bg-yellow-400 text-[#0d5c2e] rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-500">
                  <Info size={24} className="md:w-[28px] md:h-[28px]" />
                </div>
                  <h3 className="text-xl md:text-2xl font-black text-[#0d5c2e] mb-4">Sir Visvesvaraya Institute of Technology</h3>
                  <p className="text-gray-600 leading-relaxed text-left md:text-justify text-sm md:text-base">
            ...
            <div className="space-y-8 md:space-y-12 lg:mt-24">
              <div className="group p-6 md:p-8 bg-white rounded-[32px] shadow-xl shadow-black/5 hover:shadow-2xl hover:shadow-[#0d5c2e]/10 transition-all duration-500 border border-black/5">
                <div className="w-12 h-12 md:w-14 md:h-14 bg-[#0d5c2e] text-white rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-500">
                  <Lightbulb size={24} className="md:w-[28px] md:h-[28px]" />
                </div>
                  <h3 className="text-xl md:text-2xl font-black text-[#0d5c2e] mb-4">Chemical Engineering Dept.</h3>
                  <p className="text-gray-600 leading-relaxed text-left md:text-justify text-sm md:text-base">
              ...
              <div className="group p-6 md:p-8 bg-[#0d5c2e] text-white rounded-[32px] shadow-2xl shadow-[#0d5c2e]/20 hover:scale-[1.02] transition-all duration-500">
                <div className="w-12 h-12 md:w-14 md:h-14 bg-white text-[#0d5c2e] rounded-2xl flex items-center justify-center mb-6">
                  <Target size={24} className="md:w-[28px] md:h-[28px]" />
                </div>
                <h3 className="text-xl md:text-2xl font-black text-white mb-4">The ATAL FDP Program</h3>
                <p className="text-white/80 leading-relaxed text-left md:text-justify text-sm md:text-base">
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            <div className="bg-white p-6 md:p-10 rounded-[40px] border border-[#0d5c2e]/10 shadow-xl relative overflow-hidden group">
              ...
              <h3 className="text-xl md:text-2xl font-black text-[#0d5c2e] mb-8 flex items-center gap-3">
                <span className="w-8 md:w-10 h-1 bg-[#0d5c2e] rounded-full" />
                OBJECTIVES
              </h3>
                <ul className="space-y-4 md:space-y-6">
                  {[
                    ...
                    <li key={i} className="flex gap-4 items-start text-gray-700 font-medium text-sm md:text-base">
            ...
            <div className="bg-white p-6 md:p-10 rounded-[40px] border border-yellow-400/20 shadow-xl relative overflow-hidden group">
              ...
              <h3 className="text-xl md:text-2xl font-black text-[#0d5c2e] mb-8 flex items-center gap-3">
                <span className="w-8 md:w-10 h-1 bg-yellow-400 rounded-full" />
                EXPECTED OUTCOMES
              </h3>
                <ul className="space-y-4 md:space-y-6">
                  {[
